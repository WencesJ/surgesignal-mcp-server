...
export const TOPIC_KEYWORDS: Record<CoveredTopic, string[]> = {
  ...
  "data-warehouse": ["data warehouse", "snowflake", "bigquery", "redshift", "databricks", "data lake", "analytical database", "columnar storage", "cloud warehouse", "data platform"],
  ...
  "monitoring": ["monitoring", "observability", "datadog", "new relic", "grafana", "prometheus", "alerting", "apm", "log management", "infrastructure monitoring"],
